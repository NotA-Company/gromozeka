...
async def step_by_step_example():
    ...
    client = OpenWeatherMapClient(apiKey="your_api_key_here", cache=cache)
...
async def multiple_cities_example():
    ...
    cities = [("Moscow", "RU"), ("London", "GB"), ("New York", "US"), ("Tokyo", "JP"), ("Sydney", "AU")]
...
async def cache_demonstration():
    ...
    client = OpenWeatherMapClient(apiKey="your_api_key_here", cache=cache, weatherTTL=60)  # Short TTL for demonstration
...
async def error_handling_example():
    ...
    client = OpenWeatherMapClient(apiKey="invalid_key", cache=cache)  # Invalid API key
...
async def configuration_example():
    ...
    client = OpenWeatherMapClient(  # noqa: F841
