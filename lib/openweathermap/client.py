...
from .models import CurrentWeather, GeocodingResult, WeatherData, CombinedWeatherResult
...
class OpenWeatherMapClient:
    ...
    def __init__(
        ...
        geocodingTTL: int = 2592000,  # 30 days
        weatherTTL: int = 1800,        # 30 minutes
    ...
    async def __aenter__(self):
        ...
        self.session = httpx.AsyncClient(timeout=self.requestTimeout)
        return self
    ...
    async def getWeather(
        ...
        for dailyItem in responseData.get("daily", [])[:8]:  # Max 8 days
            ...
            dailyForecasts.append(daily_weather)
