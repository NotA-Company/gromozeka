...
from lib.markdown import markdown_to_html, markdownToMarkdownV2  # noqa: E402
...
print("\nMarkdownV2:")
print(markdownToMarkdownV2(text1))
print("\nHTML:")
...
print("\nMarkdownV2:")
print(markdownToMarkdownV2(text2))
print("\nHTML:")
...
print("\nMarkdownV2:")
print(markdownToMarkdownV2(text3))
print("\nHTML:")
