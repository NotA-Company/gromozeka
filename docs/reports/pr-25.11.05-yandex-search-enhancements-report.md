...
```git diff $(git merge-base master HEAD) --stat
 ...
 Makefile                                                      |  51 +++++++-------
 TODO.md                                                       |   1 +
 docs/reports/pr-25.11.05-yandex-search-enhancements-report.md | 274 ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 docs/templates/pr-template.md                                 | 304 +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
 internal/bot/handlers/yandex_search.py                        | 154 +++++++++++++++++++++++++++++++++---------
 lib/ai/providers/basic_openai_provider.py                     |  16 +++++
 requirements.direct.txt                                       |   3 +-
 requirements.txt                                              |  11 +--
 9 files changed, 761 insertions(+), 60 deletions(-)
```
...
ecaad5d - Vladimir Goshev, 24 minutes ago : make format
279580e - Vladimir Goshev, 29 minutes ago : LLM-getUrlContent: properly handle error codes and non-text content
c2591de - Vladimir Goshev, 30 minutes ago : Fixed docstring to LLM-web-search function
f872d65 - Vladimir Goshev, 30 minutes ago : Fixed comment to llm-function
63cc12d - Vladimir Goshev, 49 minutes ago : Add PR doc
f3d0454 - Vladimir Goshev, 78 minutes ago : WebSearch Tool: Add ability to download documents and return them instead of links
3419409 - Vladimir Goshev, 2 hours ago : Add PR Template
3c0618a - Vladimir Goshev, 3 hours ago : Yandex Search Handler: Add support for different amount of results + add support for markdown-parsed output (up to 20 times less text for LLM)
7752e21 - Vladimir Goshev, 3 hours ago : A bit better error handling in OpenAI-based models
b714aff - Vladimir Goshev, 6 hours ago : add list-outdated-requirements Makefile target + tidy it a bit
f2ecc3d - Vladimir Goshev, 6 hours ago : Add html-to-markdown==2.5.6
```
