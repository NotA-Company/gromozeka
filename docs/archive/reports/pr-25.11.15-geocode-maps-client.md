...
Этот PR реализует комплексную клиентскую библиотеку Geocode Maps, которая предоставляет функции геокодирования и обратного геокодирования для проекта Gromozeka. Реализация включает универсальный интерфейс кэша, который заменяет предыдущие реализации кэша в клиентах OpenWeatherMap и Yandex Search, улучшая повторное использование кода и его поддерживаемость.

**Ключевое изменение:** Добавлен клиент Geocode Maps с универсальным интерфейсом кэша и интегрирован в обработчик погоды.
