...
from lib.divination.base import Reading, _safeFormat
from lib.divination.decks.tarot_rws import TAROT_RWS_DECK
from lib.divination.layouts import TAROT_LAYOUTS, Layout
...
def testBuildInterpretationMessagesRendersAllPlaceholders() -> None:
    ...
    from lib.divination.localization import SYMBOL_NAMES, tr
...
def testReversedTagAppearsForReversedDraws() -> None:
    ...
    from lib.divination.base import DrawnSymbol
