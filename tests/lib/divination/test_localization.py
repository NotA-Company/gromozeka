...
from lib.divination.decks.runes_elder_futhark import RUNES_ELDER_FUTHARK_DECK
from lib.divination.decks.tarot_rws import TAROT_RWS_DECK
from lib.divination.layouts import RUNE_LAYOUTS, TAROT_LAYOUTS
from lib.divination.localization import LAYOUT_NAMES, POSITION_NAMES, SYMBOL_NAMES, tr
