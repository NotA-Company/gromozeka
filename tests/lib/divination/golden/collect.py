...
Usage::
    ...
    OPENROUTER_API_KEY=sk-or-... ./venv/bin/python3 tests/lib/divination/golden/collect.py
...
# Directory layout — mirrors tests/lib/openweathermap/golden/.
INPUT_DIR: str = "input"
OUTPUT_DIR: str = "data"
...
async def main() -> None:
    ...
    parser: argparse.ArgumentParser = argparse.ArgumentParser(
        ...
        usage=(
            ...
            "  ./venv/bin/python3 tests/lib/divination/golden/collect.py\n"
            "\n"
            "Recorded fixtures are written to tests/lib/divination/golden/data/."
        ),
    )
    parser.add_argument(
        "--input",
