...
from tests.lib.divination.golden import GOLDEN_DATA_PATH
from tests.lib.divination.golden.scenario_runner import (
    SYSTEM_CLASSES,
...
def test_replayerPromptBuildingMatches(fixturePath: str) -> None:
    ...
    async def _buildOnly() -> Dict[str, Any]:
        ...
        from tests.lib.divination.golden.scenario_runner import buildReading, messagesToDicts
