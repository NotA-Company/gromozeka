...
.. code-block:: bash
    ...
    ./venv/bin/python3 tests/lib/ai/golden/collect.py --provider openrouter

    export YC_API_KEY=...
    export YC_FOLDER_ID=...
    ./venv/bin/python3 tests/lib/ai/golden/collect.py --provider yc_openai
...
from lib.aurumentation.collector import collectGoldenData
from lib.aurumentation.types import ScenarioDict
from tests.lib.ai.golden.openai_patcher import OpenAIRecorderPatcher
...
Examples:
  ...
  ./venv/bin/python3 tests/lib/ai/golden/collect.py --provider basic_openai

  # Collect for all providers
  ./venv/bin/python3 tests/lib/ai/golden/collect.py --all

  # Collect with custom output directory
  ./venv/bin/python3 tests/lib/ai/golden/collect.py --provider basic_openai --output-dir /tmp/golden-data
        """,
    )
    parser.add_argument(
